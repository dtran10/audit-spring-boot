...
public interface PersistentAuditEventRepository extends Repository<PersistentAuditEvent, Long> {
	 ...
	 * 
	 * @param after
	 *            timestamp of earliest result required (or {@code null} if
	 *            unrestricted)
	 * @return audit events
	 */
	 ...
	 *            unrestricted)
	 * @param pageable
	 *            subset of the events that should be returned.
	 * @return audit events
	 */
	@Query("select ae from PersistentAuditEvent ae where time >= :after")
	...
	/**
	 * Find audit events since the time provided that were generated by the
	 * given principal.
	 * 
	 * @param principal
