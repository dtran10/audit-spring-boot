...
/**
 * <p>
 * Configures the automatic generation of Swagger v2 API documentation for all
 * endpoint exposed by this application.
 * </p>
 * 
 * <p>
 * This configuration exposes the following API documentation endpoints:
 * </p>
 * <ul>
...
public class DocumentationConfig {
	...
	private ApiInfo apiInfo() {
		...
		ApiInfo info = new ApiInfo(appName, appDescription, appVersion, "", contact, "", "");
		return info;
	}
}
